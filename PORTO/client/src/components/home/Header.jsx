      ...
      <div className="py-2 px-4 mt-5">
        <div className="max-w-6xl mx-auto ">
          <div className="flex flex-wrap lg:flex-nowrap justify-between items-center">
            ...
            <div className="border border-gray-200 w-full">
              <div className="flex p-4 items-center gap-4">
                <i className="fa-solid fa-hourglass text-2xl"></i>
                <div>
        ...
        <aside className="lg:block hidden w-1/4 bg-white border border-gray-300">
          ...
          <ul className="text-gray-600 px-4 py-2">
            <li className="hover:text-blue-600 cursor-pointer border-b border-gray-200 py-2">
              <Link to={`/`}><i className="fa-solid fa-house me-2"></i>Home</Link>
            </li>
            <li className="hover:text-blue-600 cursor-pointer border-b border-gray-200 py-2">
              <Link to={`/categories`}><i className="fa-solid fa-award me-2"></i>Categories</Link>
            </li>
            <li className="hover:text-blue-600 cursor-pointer border-b border-gray-200 py-2">
              <Link to={`/cart`}><i className="fa-solid fa-cart-shopping me-2"></i>Shopping Cart</Link>
            </li>
            <li className="hover:text-blue-600 cursor-pointer border-b border-gray-200 py-2">
              <Link to={`/checkout`}><i className="fa-solid fa-cash-register me-2"></i>Checkout</Link>
            </li>
            <li className="hover:text-blue-600 cursor-pointer border-b border-gray-200 py-2">
              <Link to={`/blog`}><i className="fa-solid fa-layer-group me-2"></i>Blog</Link>
            </li>
            <li className="hover:text-blue-600 cursor-pointer border-b border-gray-200 py-2">
              <Link to={`/about`}><i className="fa-solid fa-user-group me-2"></i>About Us</Link>
            </li>
            <li className="hover:text-blue-600 cursor-pointer border-b border-gray-200 py-2">
              <Link to={`/contact`}><i className="fa-solid fa-address-book me-2"></i>Contact Us</Link>
            </li>
            <li className="hover:text-blue-600 cursor-pointer border-b border-gray-200 py-2">
              <Link to={`/login`}><i className="fa-solid fa-circle-user me-2"></i>My Account</Link>
            </li>
            <li className="hover:text-blue-600 cursor-pointer py-2">
              <Link to={`/register`}><i className="fa-solid fa-user-plus me-2"></i>Register</Link>
            </li>
          </ul>
        </aside>
